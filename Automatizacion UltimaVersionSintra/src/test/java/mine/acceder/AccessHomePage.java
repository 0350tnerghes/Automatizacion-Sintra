...
public class AccessHomePage {
    ...
    public void selectLanguage(){
        ...
        String language = driver.findElement(By.xpath("//button[@class='mat-focus-indicator mat-menu-trigger c-header__container_main__menu__list__button m-min mat-button mat-button-base ng-star-inserted']//descendant::span")).getText();
    ...
    public void selectDate(){
        ...
        String date = driver.findElement(By.xpath("//mat-panel-description[contains(text(),'09/06/2022 15:30')]")).getText();
        Assert.assertEquals("Wrong date", "09/06/2022 15:30", date);
    }
    ...
    public void fillForm(){
        ...
        homePage.completeName("Tamara");
        homePage.fillIdentityDocument("24339278B");
        homePage.completeEmail("tamara.tamaran@yahoo.com");
        ...
        Assert.assertEquals("Location doesn't exist", "Santa Cruz de Tenerife", locationName);
        Assert.assertEquals("Department doesn't exist","Estadio Heliodoro Ródriguez López", departmentName );
        Assert.assertEquals("Job doesn't exist","Consultas sobre futbol base", jobName );
        Assert.assertEquals("Complete name doesn't exist", "Tamara", completeName);
        Assert.assertEquals("ID card doesn't exist","24339278B", idCardNumber );
        Assert.assertEquals("Phone number doesn't exist","+34642333444", phoneNumber );
        Assert.assertEquals("Email name doesn't exist", "tamara.tamaran@yahoo.com.", email);
        Assert.assertEquals("Notes don't exist","LALALA", notes );
        Assert.assertEquals("Date doesn't exist","02/06/2022 15:00", date );
    }
