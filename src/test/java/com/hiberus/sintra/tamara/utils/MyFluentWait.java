package com.hiberus.sintra.tamara.utils;
...
public class MyFluentWait<T> implements Wait<T>
{
    ...
    private Duration timeout = FIVE_HUNDRED_MILLIS; //atributo myfluentwait
    private Duration interval = FIVE_HUNDRED_MILLIS;//atributo myfluentwait
